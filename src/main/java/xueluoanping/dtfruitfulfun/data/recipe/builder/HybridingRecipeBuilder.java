...
//         this.result = result;
//         currentConditions.add(new ModuleLoadedCondition(new Identifier("hybridization")));
//     }
//
...
//         consumerIn.accept(new Result(new Identifier(DTFruitfulFun.MOD_ID, "hybriding/" + BuiltInRegistries.BLOCK.getKey(this.result).getPath()), this.currentConditions, this.ingredients, this.result));
//     }
//
...
//
//         public Result(Identifier id, List<ICondition> currentConditions, List<Block> ingredients, Block result) {
//             this.ingredients = ingredients;
//             this.result = result;
//             this.id = id;
